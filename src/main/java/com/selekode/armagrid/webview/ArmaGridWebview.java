package com.selekode.armagrid.webview;
...
public class ArmaGridWebview extends Application {
	...
	public void start(Stage stage) {
		...
		stage.setTitle("ArmaGrid");

		
		Image icon = new Image(getClass().getResourceAsStream("/static/images/armagrid-logo.png"));
		...
		webView.getEngine().load("http://localhost:8080/dashboard/");
